...
// UpvoteCrypto receives context and request with crypto id as parameters. Returns CryptoVotes struct containing the updated number of votes.
func (s *Server) UpvoteCrypto(ctx context.Context, req *pb.CryptoId) (*pb.CryptoVotes, error) {
